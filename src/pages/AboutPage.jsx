        ...
        <>
            ...
            <div className="grid md:grid-cols-2 sm:grid-cols-1">
                ...
                <div className="flex flex-col items-center justify-center mx-3">
                    <h2 className="my-10 text-2xl font-gilda">Etsy Shop - My little Crafting Space</h2>
                    ...
                    <Link to="https://www.etsy.com/de/shop/MadebyMonaAtelier?ref=profile_header">
                        <button
                            className="inline-flex items-center justify-center h-7 my-10 mr-3 px-3 font-gilda text-s text-gray-900 bg-mint border border-darkmint rounded-lg focus:outline-none hover:bg-darkgreen-100 hover:text-beige-700"
