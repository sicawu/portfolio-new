...
function ContactPage() {
    ...
    const handleDownload = () => {
        saveAs("../img/CV-Simona-Wurst-EN.pdf")
    }
    ...
    return (
        ...
        <div className="hero heroTwo h-screen flex justify-center items-end overflow-hidden">
         ...
         <p className="text-beige font-gilda">Prefer all info in a printable PDF? No worries, I've got a two-pager for you. Feel free to contact me for a CV in German, testimonials from previous employers, certificates and more. </p>
